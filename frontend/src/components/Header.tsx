        ...
        <nav className="relative z-10 p-3">
          <div className="max-w-full mx-auto px-4 flex items-center justify-between">
            ...
            <div className={`hidden md:flex items-center space-x-1 flex-nowrap`}>
              <ScrollLink to="home" smooth={true} duration={500} className="px-4 py-2 rounded-lg text-white font-medium hover:bg-white/20 cursor-pointer" activeClass="bg-white/30">Home</ScrollLink>
              <ScrollLink to="our_strength" smooth={true} duration={500} className="px-4 py-2 rounded-lg text-white font-medium hover:bg-white/20 cursor-pointer" activeClass="bg-white/30">Our Strength</ScrollLink>
              <ScrollLink to="products" smooth={true} duration={500} className="px-4 py-2 rounded-lg text-white font-medium hover:bg-white/20 cursor-pointer" activeClass="bg-white/30">Products</ScrollLink>
              <ScrollLink to="industries" smooth={true} duration={500} className="px-4 py-2 rounded-lg text-white font-medium hover:bg-white/20 cursor-pointer" activeClass="bg-white/30">Industries</ScrollLink>
              <ScrollLink to="projects" smooth={true} duration={500} className="px-4 py-2 rounded-lg text-white font-medium hover:bg-white/20 cursor-pointer" activeClass="bg-white/30">Case Studies</ScrollLink>
              <ScrollLink to="salesforce-apps" smooth={true} duration={500} className="px-4 py-2 rounded-lg text-white font-medium hover:bg-white/20 cursor-pointer" activeClass="bg-white/30">Applications</ScrollLink>
              <ScrollLink to="about4" smooth={true} duration={500} className="px-4 py-2 rounded-lg text-white font-medium hover:bg-white/20 cursor-pointer" activeClass="bg-white/30">About Us</ScrollLink>
              <ScrollLink to="contact-form" smooth={true} duration={500} className="px-4 py-2 rounded-lg text-white font-medium hover:bg-white/20 cursor-pointer" activeClass="bg-white/30">Contact Us</ScrollLink>
