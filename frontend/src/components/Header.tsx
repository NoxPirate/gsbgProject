...
const Header = () => {
  ...
  return (
    <>
      <header 
        className="fixed top-0 left-0 right-0 w-full backdrop-blur-md bg-transparent z-50 transition-all duration-300"
        onMouseEnter={() => setIsHovered(true)}
        onMouseLeave={() => setIsHovered(false)}
      >
        {/* Glass background overlay - keep blur, transparent base */}
        <div className="absolute inset-0 backdrop-blur-md" />
        <div className={`absolute inset-0 transition-colors duration-300 ${scrolled || isHovered ? "bg-white/15 shadow-md" : "bg-transparent"}`} />
            ...
            <div className="glass-content">
              <div className="max-w-7xl mx-auto px-2 py-0 flex items-center justify-between">
                ...
                <div className="hidden md:flex items-center space-x-1 flex-nowrap whitespace-nowrap">
                  <ScrollLink to="home" smooth={true} duration={500} offset={-140} className="px-1 py-0.5 rounded-lg nav-link hover:bg-transparent cursor-pointer">Home</ScrollLink>
                  <ScrollLink to="our_strength" smooth={true} duration={500} offset={-140} className="px-1 py-0.5 rounded-lg nav-link hover:bg-transparent cursor-pointer">Capabilities</ScrollLink>
                      ...
                      >
                        ...
                        <div className="glass-content">
                          <div className="flex flex-col p-2 space-y-1">
                            <Link href="/products/sales-cloud" className="group flex items-center gap-3 px-3 py-2 text-sm text-dark font-medium rounded-lg hover:bg-black/5 transition-all">
                              <span className="p-2 rounded-md bg-blue-50 text-blue-600 group-hover:scale-110 transition-transform">
                            ...
                            <Link href="/products/service-cloud" className="group flex items-center gap-3 px-3 py-2 text-sm text-dark font-medium rounded-lg hover:bg-black/5 transition-all">
                               <span className="p-2 rounded-md bg-teal-50 text-teal-600 group-hover:scale-110 transition-transform">
                                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5 0a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
                              </span>
                              Service Cloud
                            </Link>
                            <Link href="/products/cpq" className="group flex items-center gap-3 px-3 py-2 text-sm text-dark font-medium rounded-lg hover:bg-black/5 transition-all">
                            ...
                            <Link href="/products/financial-cloud" className="group flex items-center gap-3 px-3 py-2 text-sm text-dark font-medium rounded-lg hover:bg-black/5 transition-all">
                               <span className="p-2 rounded-md bg-green-50 text-green-600 group-hover:scale-110 transition-transform">
                                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                              </span>
                              Financial Cloud
                            </Link>
                            <Link href="/products/marketing-cloud" className="group flex items-center gap-3 px-3 py-2 text-sm text-dark font-medium rounded-lg hover:bg-black/5 transition-all">
                               <span className="p-2 rounded-md bg-orange-50 text-orange-600 group-hover:scale-110 transition-transform">
                  ...
                  <ScrollLink to="industries" smooth={true} duration={500} offset={-140} className="px-1 py-0.5 rounded-lg nav-link hover:bg-transparent cursor-pointer">Industries</ScrollLink>
                  <ScrollLink to="projects" smooth={true} duration={500} offset={-140} className="px-1 py-0.5 rounded-lg nav-link hover:bg-transparent cursor-pointer">Case Studies</ScrollLink>
                  <ScrollLink to="salesforce-apps" smooth={true} duration={500} offset={-140} className="px-1 py-0.5 rounded-lg nav-link hover:bg-transparent cursor-pointer">Solutions</ScrollLink>
                  <ScrollLink to="about4" smooth={true} duration={500} offset={-140} className="px-1 py-0.5 rounded-lg nav-link hover:bg-transparent cursor-pointer">About</ScrollLink>
                  ...
                  >
                    ...
                    {showServices && servicesRect && mounted && createPortal(
                      ...
                      >
                        ...
                        <div className="glass-content">
                          <div className="flex flex-col p-2 space-y-1">
                            <Link href="/services/salesforce-consulting" className="group flex items-center gap-3 px-3 py-2 text-sm text-dark font-medium rounded-lg hover:bg-black/5 transition-all">
                            ...
                            <Link href="/services/education-product" className="group flex items-center gap-3 px-3 py-2 text-sm text-dark font-medium rounded-lg hover:bg-black/5 transition-all">
                              <span className="p-2 rounded-md bg-pink-50 text-pink-600 group-hover:scale-110 transition-transform">
                                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M12 14l9-5-9-5-9 5 9 5z" /><path d="M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 14l9-5-9-5-9 5 9 5zm0 0l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14zm-4 6v-7.5l4-2.222" /></svg>
                              </span>
                              Education Product
                            </Link>
                            <Link href="/services/salesforce-professional" className="group flex items-center gap-3 px-3 py-2 text-sm text-dark font-medium rounded-lg hover:bg-black/5 transition-all">
                              <span className="p-2 rounded-md bg-cyan-50 text-cyan-600 group-hover:scale-110 transition-transform">
                ...
                {/* MOBILE MENU TOGGLE BUTTON (Visible only on md:hidden) */}
                <button
        ...
        {/* MOBILE DRAWER (Portal to body for clean overlay) */}
          ...
          <div className={`fixed inset-0 z-[100] md:hidden transition-all duration-300 ${menuOpen ? 'visible' : 'invisible'}`}>
            ...
            <div className={`absolute top-0 right-0 w-[80%] max-w-sm h-full bg-white shadow-2xl transform transition-transform duration-300 flex flex-col ${menuOpen ? 'translate-x-0' : 'translate-x-full'}`}>
              ...
              <div className="flex-1 overflow-y-auto p-6 flex flex-col space-y-4">
                 ...
                 <ScrollLink to="contact-form" smooth={true} duration={500} offset={-140} className="mt-8 w-full bg-slate-900 text-white py-4 rounded-xl text-center font-bold shadow-lg shadow-slate-300" onClick={() => setMenuOpen(false)}>Contact Us</ScrollLink>
              </div>
            </div>
          </div>,
          document.body
