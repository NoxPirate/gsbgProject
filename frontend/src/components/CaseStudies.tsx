  ...
  return (
    <section id="projects" className="py-20 bg-light">
      <div className="container mx-auto">
        <h2 className="text-3xl font-bold text-center text-dark mb-12">Our Case Studies</h2>
      ...
      <div key={index} className="bg-white rounded-lg shadow-sm hover:shadow-lg overflow-hidden transform hover:-translate-y-2 transition-transform duration-300">
        ...
        <p className="text-gray mb-4">{study.summary}</p>
                ...
                {activeIndex === index && (
                  <div className="mt-4">
                    <p className="text-dark"><strong className="text-primary">Goal:</strong> {study.goal}</p>
                    <p className="mt-2 text-dark"><strong className="text-primary">Implementation:</strong></p>
                    <ul className="list-disc list-inside ml-4 text-dark">
                      {study.implementation.map((item, i) => (
                        <li key={i}>{item}</li>
                      ))}
                    </ul>
                    <p className="mt-2 text-dark"><strong className="text-primary">Technology Used:</strong></p>
                    <ul className="list-disc list-inside ml-4 text-dark">
